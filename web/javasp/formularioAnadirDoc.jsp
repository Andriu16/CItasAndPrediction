                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <form action="../registerMedico" method='POST'enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="date" class="form-control" placeholder="" id="txtFechaNac" name="txtFechaNac" required="">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="1-8" id="txtEspecialidad" name="txtEspecialidad" required="">
